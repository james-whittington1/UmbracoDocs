...
More on working with Tags (i.e. query all of them) can be found at the [UmbracoHelper reference page](/documentation/Reference/Querying/UmbracoHelper/#working-with-tags)
